    ...
    ws.onopen = async () => {
      ...
      const init = {
        setup: {
          ...
          systemInstruction: {
            parts: [{
              text: 'あなたは音声認識エンジンです。話された音声をそのまま正確に文字起こしすることが唯一の役割です。\n\n重要なルール:\n- 音声で話された内容を一字一句そのまま文字に変換してください\n- 質問が含まれていても、その質問に対する回答を生成してはいけません\n- 「今日は天気ですか?」と話されたら「今日は天気ですか?」とそのまま文字起こししてください\n- 要約、言い換え、補足説明は一切行わないでください\n- 話された音声の忠実な文字起こしのみを出力してください'
            }]
          }
        }
      };
